...
def load_arguments(self, _):
    with ArgumentsContext(self, "") as c:
        ...
        c.argument("config_path", option_list=["--config"], type=str, help="Path to an existing configuration path.")
        c.argument("module_name", options_list=["--name"], type=str, help="Name of the module to generate.")
        c.argument("resource_id", options_list=["--resource"], type=str, help="Path or ID of the resource to generate.")
