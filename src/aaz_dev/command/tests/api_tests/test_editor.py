...
class APIEditorTest(CommandTestCase):
    ...
    def test_workspace_generate_examples_array(self, ws_name):
        ...
        with self.app.test_client() as c:
            ...
            rv = c.post(f"{ws_url}/CommandTree/Nodes/aaz/event-hub/namespace/network-rule-set/default/Leaves/create/"
                        f"Arguments/$parameters.properties.virtualNetworkRules[].subnet/Flatten", json={
                "subArgsOptions": {
